...
game1board = boardV2.board(6, 6, "[]", legalMoves)
...
game2board = boardV2.board(6, 6, "[]", legalMoves)
...
game3board = boardV2.board(6, 6, "[]", legalMoves)
...
game4board = boardV2.board(6, 6, "[]", legalMoves)
...
game5board = boardV2.board(6, 6, "[]", legalMoves)
...
game6board = boardV2.board(6, 6, "[]", legalMoves)
